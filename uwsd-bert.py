...
# mpnet-base-v2, all-MiniLM-L12-v2, all-MiniLM-L6-v2, paraphrase-albert-small-v2, paraphrase-MiniLM-L3-v2, distilroberta-v1
model=sentence_similarity(model_name='all-MiniLM-L6-v2',embedding_type='sentence_embedding')
...
def calculate(synonyms, word, context):
    ...
    for i in range(len(synonyms)):
        ...
        if word.lower() != cons.lower():
            ...
            target = context            
            result = 1-model.get_score(source,target,metric="cosine")
